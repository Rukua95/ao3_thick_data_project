...
public class SortWordCounts {
    ...
    public static class SortWordCountsMapper extends
        ...
        /**
         * @throws InterruptedException Each input line should be as follows:
         *                              <p>
         *                              word[\t]count
         *                              <p>
         *                              Parse this and map count as key, word as value.
         *                              <p>
         *                              Note DescendingIntWritable, which offers inverse sorting (largest first!)
         */
        @Override
    ...
    public static class SortWordCountsReducer
        ...
        /**
         * @throws InterruptedException The keys (counts) are called in descending order ... ... so for
         *                              each value (word) of a key, we just write (value,key) pairs to the output and we're done.
         */
        @Override
    ...
    /**
     * A class that inverts the order for IntWritable objects so we can do a descending order.
     *
     * @author ahogan
     */
