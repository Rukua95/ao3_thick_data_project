...
public class CountTagsPerYear {
    ...
    public static class CountTagsPerYearMapper extends Mapper<Object, Text, Text, IntWritable>{
    ...
    public static class CountTagsPerYearReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (otherArgs.length != 2) {
            System.err.println("Usage: "+CountTagsPerYear.class.getName()+" <in> <out>");
            System.exit(2);
        }
        ...
        job.setMapperClass(CountTagsPerYearMapper.class);
        job.setCombinerClass(CountTagsPerYearReducer.class); // in this case a combiner is possible!
        job.setReducerClass(CountTagsPerYearReducer.class);

        job.setJarByClass(CountTagsPerYear.class);
